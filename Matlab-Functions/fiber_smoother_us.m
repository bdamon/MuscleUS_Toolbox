...
%      in units of mm.  For example, setting interp_distance to 0.25 would
%      interpolate the fiber tract at intervals of 0.25 mm. Prior to
%      fitting the pixel positions, interp_distance is converted to units
%      of pixels
%
...
%    fiber_visualizer_us is automatically called so that the smoothed
%    tracts can be visualized.
%
%OUTPUT ARGUMENTS
