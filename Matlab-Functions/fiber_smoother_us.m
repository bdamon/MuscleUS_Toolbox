...
%
%FUNCTION fiber_smoother_usfunction [smoothed_fiber_all_pixels, smoothed_fiber_all_mm, coeff_c_pixels, coeff_r_pixels, coeff_x_mm, coeff_y_mm] = ...
...
smoothed_fiber_all_pixels = zeros(size(fiber_all));
smoothed_fiber_all_mm = smoothed_fiber_all_pixels;
for track_cntr=1:length(fiber_all(:,1,1))

    if length(nonzeros(fiber_all(track_cntr,:,2)))>5
