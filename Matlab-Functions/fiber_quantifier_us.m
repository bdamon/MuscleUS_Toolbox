...
%     fiber tracts, calculated using fiber_smoother_us. 
%
...
%    of mm. This matrix could be substituted with smoothed_fiber_all_mm 
%    (the output of fiber_smoother_us)
%
...
%  degrees
%
%  tract_lengths: A vector containing the fiber tract lengthsof each tract, 
%  in mm
%
